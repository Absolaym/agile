...
public abstract class TemplateTSP implements TSP {
     ...
     * nbSommets et 0 <= j < nbSommets @param duree : duree[i] = duree pour
     * visiter le sommet i, avec 0 <= i < nbSommets @retur n une borne
     * inferieure du cout des permutations commencant par sommetCourant,
     * contenant chaque sommet de nonVus exactement une fois et terminant par le
     * sommet 0
     */
     ...
     * @param cout : cout[i][j] = duree pour aller de i a j, avec 0 <= i <
     * nbSommets et 0 <= j < nbSommets @param duree : duree[i] = duree pour
     * visiter le sommet i, avec 0 <= i < nbSommets @retur n un iterateur
     * permettant d'iterer sur tous les sommets de nonVus
     */
     ...
     * @param cout : cout[i][j] = duree pour aller de i a j, avec 0 <= i <
     * nbSommets et 0 <= j < nbSommets @param duree : duree[i] = duree pour
     * visiter le sommet i, avec 0 <= i < nbSommets @param tpsDebut : moment ou
     * la resolution a commence @param tpsLimite : limite de temps pour la
     * resolution
     */
